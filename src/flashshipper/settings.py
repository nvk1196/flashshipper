"""
Django settings for flashshipper project.
...
SECRET_KEY = 'e4-agq3yf5jjp$2vkn)qkr)4(oe3c4((jm5!z8ian20liz2v)6'
...
ROOT_URLCONF = 'flashshipper.urls'
...
WSGI_APPLICATION = 'flashshipper.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.fs_database'),
    }
}
